...
class BitacoraTablaPolicy
{
    ...
    {
        return $user->can('api:bitacora-tablas:listar');
    }
    ...
    {
        return $user->can('api:bitacora-tablas:crear');
    }
    ...
    {
        return $user->can('api:bitacora-tablas:actualizar');
    }
    ...
    {
        return $user->can('api:bitacora-tablas:eliminar');
    }
