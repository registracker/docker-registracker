...
class MedioDesplazamientoPolicy
{
    ...
    {
        return $user->tokenCan('medio_desplazamiento:listar');
    }
    ...
    {
        return $user->tokenCan('medio_desplazamiento:crear');
    }
    ...
    {
        return $user->tokenCan('medio_desplazamiento:actualizar');
    }
    ...
    {
        return $user->tokenCan('medio_desplazamiento:eliminar');
    }
