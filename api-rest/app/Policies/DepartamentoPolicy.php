...
class DepartamentoPolicy
{
    ...
    {
        return $user->can('api:departamento:listar');
    }
    ...
    {
        return $user->can('api:departamento:crear');
    }
    ...
    {
        return $user->can('api:departamento:actualizar');
    }
    ...
    {
        return $user->can('api:departamento:eliminar');
    }
